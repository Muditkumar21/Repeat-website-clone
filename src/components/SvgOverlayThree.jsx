...
const SvgOverlayThree = ({ targetRef, svgUrl, width = 150, height = 200, offsetX = 0, offsetY = 0 }) => {
  ...
  useEffect(() => {
    ...
    let svgElement = document.getElementById('cream-svg-label');
    if (!svgElement) {
      svgElement = document.createElement('img');
      svgElement.id = 'cream-svg-label';
    ...
    return () => {
      const existingElement = document.getElementById('cream-svg-label');
...
export default SvgOverlayThree;