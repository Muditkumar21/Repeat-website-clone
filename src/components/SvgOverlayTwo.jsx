...
const SvgOverlayTwo = ({ targetRef, svgUrl, width = 150, height = 200, offsetX = 0, offsetY = 0 }) => {
  ...
  useEffect(() => {
    ...
    let svgElement = document.getElementById('medicine-svg-label');
    if (!svgElement) {
      svgElement = document.createElement('img');
      svgElement.id = 'medicine-svg-label';
    ...
    return () => {
      const existingElement = document.getElementById('medicine-svg-label');
