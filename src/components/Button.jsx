...
function Button({ heading, paddingx, paddingy, svgheight, gap, margintop, marginleft, marginright , border }) {
  ...
  return (
    <div>
      <div
        ...
        className={`relative ${margintop} ${marginleft} ${marginright} inline-flex justify-center items-center text-base font-main border-solid border bg-black ${border} rounded-full whitespace-nowrap overflow-hidden`}
      >
        ...
        <div ref={extraTextRef} className="absolute left-[5rem] font-main text-base text-white">
          {heading}
        </div>
        <div ref={firstCircleRef} className="absolute top-[20%] right-[8%] w-[4rem] h-[4rem] rounded-full bg-yelloww" />
        <div ref={copyRef} style={{ 
          padding: `${paddingy}rem ${paddingx}rem`, 
          gap: `${gap}rem`,
        }}
        className="absolute z-[3] left-[-30rem] inline-flex justify-center items-center text-base font-main bg-yelloww rounded-full whitespace-nowrap"
        >
          <svg
        ...
        <div ref={mainTextRef} className="z-[1]">{heading}</div>
      </div>
    </div>
  );
}
